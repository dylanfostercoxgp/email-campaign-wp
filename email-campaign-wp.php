...
require_once ECWP_PLUGIN_DIR . 'includes/class-ecwp-link-tracker.php';
require_once ECWP_PLUGIN_DIR . 'includes/class-ecwp-automations.php';
...
function ecwp_init() {
	...
	( new ECWP_Link_Tracker() )->init();
	( new ECWP_Automations() )->init();
